...
def ending(): #if the player beats the game, this screen pops up
    global username #makes the username variable work
    print("\033[1;32;m")
...
def time_question1():
    ...
    def run_timer(duration, stop_event):
        global health
        print("Timer: ", end="", flush=True)  # Print "Timer: " only once to avoid overwriting.
        for remaining in range(duration, 0, -1):
            if stop_event.is_set():  # Check if the stop event has been triggered
                print(f"\n          ", end='', flush=True)  # checks to see if the timer is interrupted
                break
            print(f"\r\x1B[4mPlease Type 1, 2, or 3 to select one of the options, answer to the right of this message\u001b\033[0m             Timer: {remaining} seconds:          ", end='', flush=True)  # Update the timer line
            time.sleep(1)
        else:
            print(f"\r Time's up! You did not answer in time!                                                                                                                ", end='', flush=True)  # Final timer message

            random_punishment = random.randint(0,1) #since the player did not answer in time, they receive a random punishment 
            
            if random_punishment == 0: #this punishment makes the player lose health
                time.sleep(0.5)
                input("")
                print("\u001b[31mIncorrect\u001b")
                input("")
            ...
            elif random_punishment == 1: #this punishment makes the player lose cargo
                time.sleep(0.5)
                input("")
                print("\u001b[31mIncorrect\u001b")
                input("")
    ...
    def ask_question(stop_event):
        global health
        print("\n")  # Blank line for separation after the timer

        # Print the question and leave space for the answer
        print("\n")
        print("\u001b[33mQuestion #1: Which is a popular Cantonese dim sum dish made from shrimp?\u001b[0m\n") #prints the question and below it prints the options. The stuff before and after the question is to change the colour of the text.
        print("")
        print("1. Har Gow")
        print("2. Xianglongbao")
        print("3. Juk Gow")
        print("")  # Extra blank line for input separation

        # Take user input
        answer = input()  # This will allow the input to be visible
        stop_event.set()  # Trigger the stop event to stop the timer

        if answer == "1": #if the user gets the question correct
            time.sleep(0.5)
            print("")
            print("\u001b[32mCorrect!\u001b")
            input("")
        ...
        elif answer == "2" or answer == "3" or answer == "": #if the user gets the question wrong
        ...
        # If we want to exit the program after the answer, we can use sys.exit() here.
        sys.exit()
    ...
    timer_thread = threading.Thread(target=run_timer, args=(timer_duration, stop_event))
    timer_thread.start()

    # Ask the question in the main thread while the timer runs
    ask_question(stop_event)

    # Wait for the timer thread to finish (in case it hasn't already)
    timer_thread.join()
...
def time_question2():
    ...
    def ask_question(stop_event):
        ...
        if answer == "2": #if the user gets the question correct
            time.sleep(0.5)
            print("")
            print("\u001b[32mCorrect!\u001b")
            input("")
            ...
            print(" This is what cargo you have left: " + str(goodies_list) + ".")
            input("\u001b[37m \u001b")
            time_question3() #brings the player to the next question

        elif answer == "1" or answer == "3" or answer == "": #if the user gets the question wrong
            random_punishment = random.randint(0,1) 
...
def time_question3():
    ...
    def ask_question(stop_event):
        ...
        if answer == "1": #if the user gets the question correct
            ...
            print(" This is what cargo you have left: " + str(goodies_list) + ".")
            input("\u001b[37m \u001b")
            time_question4() #brings the player to the next question
...
def time_question4():
    ...
    def ask_question(stop_event):
        ...
        if answer == "2": #if the user gets the question correct
            ...
            print(" This is what cargo you have left: " + str(goodies_list) + ".")
            input("\u001b[37m \u001b")
            time_question5() #brings the player to the next question
...
def time_question5():
    ...
    def run_timer(duration, stop_event):
        ...
        for remaining in range(duration, 0, -1):
            ...
            if random_punishment == 0: #this punishment makes the player lose health
                ...
                else: #if they still have cargo and health left, the game continues
                    input("")
                    print(" Oh no! A robber cut you with a knife! Your health is currently: "+ str(health)) 
                    print("\u001b[37m \u001b")
                    input("")
    ...
    def ask_question(stop_event):
        ...
        if answer == "3": #if the user gets the question correct
            time.sleep(0.5)
            print("")
            print("\u001b[32mCorrect!\u001b")
            input("")
            ...
            print(" This is what cargo you have left: " + str(goodies_list) + ".")
            input("\u001b[37m \u001b")
            time_question6() #brings the player to the next question


        elif answer == "1" or answer == "2" or answer == "":
            random_punishment = random.randint(0,1) 
...
def time_question6():
    ...
    def ask_question(stop_event):
        ...
        if answer == "1": #if the user gets the question correct
            ...
            print(" This is what cargo you have left: " + str(goodies_list) + ".")
            input("\u001b[37m \u001b")
            time_question7() #brings the player to the next question


        elif answer == "2" or answer == "3" or answer == "":
            random_punishment = random.randint(0,1) 
...
def time_question7():
    ...
    def ask_question(stop_event):
        ...
        if answer == "2": #if the user gets the question correct
            ...
            print(" This is what cargo you have left: " + str(goodies_list) + ".")
            input("\u001b[37m \u001b")
            time_question8() #brings the player to the next question


        elif answer == "1" or answer == "3" or answer == "":
            random_punishment = random.randint(0,1) 
...
def time_question8():
    ...
    def ask_question(stop_event):
        ...
        if answer == "3": #if the user gets the question correct
            ...
            print(" This is what cargo you have left: " + str(goodies_list) + ".")
            input("\u001b[37m \u001b")
            time_question9() #brings the player to the next question
...
def time_question10():
        ...
        for remaining in range(duration, 0, -1):
            ...
            if random_punishment == 0: #this punishment makes the player lose health
                ...
                if len(goodies_list) == 0: #if the goodies_list is empty
                    ...
                    print(" This is what cargo you have left: " + str(goodies_list) + ".")
                    input("")
                    ending() #brings player to the ending of the game
    ...
    def ask_question(stop_event):
        ...
        if answer == "1": #if the user gets the question correct
            ...
            print(" This is what cargo you have left: " + str(goodies_list) + ".")
            input("\u001b[37m \u001b")
            ending() #brings the player to the next question
